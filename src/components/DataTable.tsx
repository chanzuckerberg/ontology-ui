      ...
      >
        <div className={Classes.DRAWER_BODY}>
          <div className={Classes.DIALOG_BODY}>
            <Button icon="duplicate">Copy data table to SVG</Button>
            <div style={{ width: tableWidth, display: "flex", justifyContent: "flex-start" }}>
              <pre style={{ marginBottom: 20, lineHeight: 1, fontSize: 10, width: 90 }}>Cell Type</pre>
              <pre style={{ marginBottom: 20, lineHeight: 1, fontSize: 10, width: 335 }}>Cell</pre>
              <pre style={{ marginBottom: 20, lineHeight: 1, fontSize: 10, width: 200 }}>Count</pre>
              <pre style={{ marginBottom: 20, lineHeight: 1, fontSize: 10, width: 200 }}>W. Desc.</pre>
            </div>
